...
Complete schema reference for state.json, TODO.md, and artifact formats. For behavioral rules (transitions, update patterns), see `.opencode/context/core/rules/state-management.md`.
...
**Implementation Reference**: For the full four-case Edit tool logic used by skills during postflight, see `.opencode/context/core/patterns/artifact-linking-todo.md`.
