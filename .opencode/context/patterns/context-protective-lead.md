...
| 2 | **Loading format specs** | `cat format-spec.md` in lead preflight for passthrough | Pass `@.opencode/context/formats/report-format.md` reference to subagent | Medium (88-426 lines) |
...
See `.opencode/docs/architecture/handoff-schema.md` for the full handoff JSON schema.
See `.opencode/docs/architecture/orchestrate-state-machine.md` for the lifecycle state machine.
...
| skill-team-research | Compliant | 0 | Refactored |
...
- **Handoff Schema** (`.opencode/docs/architecture/handoff-schema.md`) -- Full schema for the 400-token handoff JSON.
- **Orchestrate State Machine** (`.opencode/docs/architecture/orchestrate-state-machine.md`) -- The lifecycle state machine that demonstrates this pattern.
