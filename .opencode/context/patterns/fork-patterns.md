...
- @.opencode/context/architecture/system-overview.md - System architecture overview
- @.opencode/context/patterns/thin-wrapper-skill.md - Thin wrapper pattern reference
- @.opencode/context/templates/thin-wrapper-skill.md - Full skill template
- @.opencode/docs/guides/creating-skills.md - Step-by-step skill creation guide
