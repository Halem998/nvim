...
*Updated 2026-05-15. Generated from state.json. Tasks {N}-{M} archived.*
```
...
The `## Task Order` section is auto-generated by `.opencode/scripts/generate-task-order.sh`.

### Script Usage

```bash
# Print to stdout (inspection)
.opencode/scripts/generate-task-order.sh --print

# Replace Task Order section in TODO.md
.opencode/scripts/generate-task-order.sh --update-todo specs/TODO.md specs/state.json

# Replace section with custom goal line
.opencode/scripts/generate-task-order.sh --update-todo specs/TODO.md specs/state.json --goal "Custom goal text"
```
...
- @.opencode/scripts/generate-task-order.sh — Auto-generation script
- @.opencode/scripts/update-task-status.sh — Phase 3 status update (uses patterns above)
