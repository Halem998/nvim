...
**Always Load**:
- `@.opencode/extensions/founder/context/project/founder/domain/spreadsheet-frameworks.md` - Cost structure, formulas, conventions
- `@.opencode/extensions/founder/context/project/founder/patterns/cost-forcing-questions.md` - Question framework
