...
**Always Load**:
- `@.opencode/context/formats/plan-format.md` - Standard plan format (required metadata and sections)
...
- `@.opencode/extensions/founder/context/project/founder/patterns/legal-planning.md` - Contract analysis planning guidance
- `@.opencode/extensions/founder/context/project/founder/patterns/project-planning.md` - Project management reference (WBS, PERT, CPM)
...
**Template**: .opencode/extensions/founder/context/project/founder/templates/typst/{report-type}.typ
