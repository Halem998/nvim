...
- `@.opencode/extensions/present/context/project/present/README.md` - Grant domain overview
...
See `.opencode/context/patterns/context-discovery.md` for additional query patterns.
