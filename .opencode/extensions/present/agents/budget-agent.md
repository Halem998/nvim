...
**Always Load**:
- `@.opencode/extensions/present/context/project/present/domain/grant-budget-frameworks.md` - Cost structures, F&A rules, salary caps
- `@.opencode/extensions/present/context/project/present/patterns/budget-forcing-questions.md` - Question framework

**Load for Reference**:
- `@.opencode/extensions/present/context/project/present/patterns/budget-patterns.md` - NSF/NIH/Foundation format templates
- `@.opencode/extensions/present/context/project/present/templates/budget-justification.md` - Justification templates
