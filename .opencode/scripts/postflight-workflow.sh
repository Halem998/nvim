...
#
# Usage: bash .opencode/scripts/postflight-workflow.sh TASK_NUMBER ARTIFACT_PATH [ARTIFACT_SUMMARY] OPERATION_TYPE
#
...
#
# Uses two-step jq pattern to avoid Issue #1132 (OpenCode Bash tool escaping bug).
