...
These validation rules are now ACTIVELY ENFORCED by command files Stage 3 (ValidateReturn). Prior to this enforcement, these rules were documented but not executed, leading to "phantom research" incidents where agents claimed completion without creating artifacts.
