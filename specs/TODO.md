...
- **Topic**: extensions
- **Dependencies**: None
- **Research**: [816_close_task815_phase6_wrapper_contract_docs/reports/01_phase6-docs-closure.md]
- **Plan**: [816_close_task815_phase6_wrapper_contract_docs/plans/01_phase6-docs-closure.md]
- **Summary**: [816_close_task815_phase6_wrapper_contract_docs/summaries/01_phase6-docs-closure-summary.md]
...
- **Topic**: agent-system
- **Dependencies**: None
- **Research**: [807_validate_handoff_skeleton_field/reports/01_validate-handoff-skeleton-field.md]
- **Plan**: [807_validate_handoff_skeleton_field/plans/01_validate-handoff-skeleton-field.md]
- **Summary**: [807_validate_handoff_skeleton_field/summaries/01_validate-handoff-skeleton-field-summary.md]
...
- **Topic**: agent-system
- **Dependencies**: None
- **Research**: [806_lean_cslib_strategic_sorry_alignment/reports/01_lean-cslib-sorry-alignment.md]
- **Plan**: [806_lean_cslib_strategic_sorry_alignment/plans/01_strategic-sorry-alignment.md]
- **Summary**: [806_lean_cslib_strategic_sorry_alignment/summaries/01_strategic-sorry-alignment-summary.md]
...
- **Dependencies**: None
- **Research**:
  - [803_email_claude_code_extension/reports/01_email-extension-seed.md]
  - [803_email_claude_code_extension/reports/02_authoring-contract-verification.md]
- **Plan**: [803_email_claude_code_extension/plans/03_author-email-extension.md]
- **Summary**: [803_email_claude_code_extension/summaries/02_author-email-extension-summary.md]
...
- **Topic**: agent-system
- **Dependencies**: Task 780
- **Research**: [781_agent_context_overflow_checkpoint_handoff/reports/01_context_overflow_checkpoint_handoff.md]
- **Plan**: [781_agent_context_overflow_checkpoint_handoff/plans/01_checkpoint-before-overflow.md]
...
- **Research**: [779_hardmode_fix_forward_recovery_contract/reports/01_fix-forward-recovery-contract.md]
- **Plan**: [779_hardmode_fix_forward_recovery_contract/plans/01_recovery-contract-fix-forward.md]
...
- **Research**: [774_hardmode_chunk_sizing_phase_subdivision/reports/01_skeleton_followup_phase_sizing.md]
- **Plan**: [774_hardmode_chunk_sizing_phase_subdivision/plans/01_skeleton-followup-phase-sizing.md]
