...
66 [RESEARCHING] — Mandate detached (run_in_background) invocation for Lean full bui
...
98 [RESEARCHED] — Integrate the shared Lean build guard into the lean extension: ro
