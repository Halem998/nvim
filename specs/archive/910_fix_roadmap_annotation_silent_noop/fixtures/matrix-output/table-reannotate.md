...
|-----------|----------------|--------|----------|
| Widget Driver | GPIO4 | Complete (task 501) *(Completed: Task 501)* | src/widget.lua |
...
|-----------|-------|--------|--------|----------|
| Sprocket Cache | teamA | us-east | Resolved (task 502) *(Completed: Task 502)* | src/sprocket.lua |
